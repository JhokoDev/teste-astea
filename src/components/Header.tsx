    ...
    <header className="flex items-center justify-between px-4 lg:px-8 py-4 bg-[#FBFDF9] dark:bg-app-card border-b border-primary/5 dark:border-app-border sticky top-0 z-10 transition-colors duration-300">
      <div className="flex items-center gap-4 lg:gap-8">
        ...
        <nav className="hidden md:flex items-center gap-2 text-sm">
          ...
          <ChevronRight className="w-4 h-4 text-slate-400 dark:text-app-muted" />
          <span className="text-slate-900 dark:text-app-fg font-bold">Nome da Feira</span>
        </nav>
        ...
        <div className="relative w-40 sm:w-64 lg:w-72">
          ...
          <input 
            type="text" 
            placeholder="Search" 
            className="w-full bg-primary/5 dark:bg-app-surface border-none rounded-xl pl-10 py-2 text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all text-slate-900 dark:text-app-fg"
          />
        </div>
      </div>

      <div className="flex items-center gap-2 lg:gap-4">
        <button className="p-2 text-slate-600 dark:text-app-muted hover:bg-primary/5 dark:hover:bg-primary/10 rounded-full relative transition-colors">
        ...
        <div className="flex items-center gap-2 lg:gap-3 pl-2 lg:pl-4 border-l border-slate-100 dark:border-app-border">
          ...
          <button 
            ...
            className="p-2 text-slate-400 dark:text-app-muted hover:text-red-500 transition-colors"
            title="Sair"
          >
