...
export function StageFunnel({ stages }: { stages: Stage[] }) {
  return (
    <div className="bg-white elevation-1 rounded-xl p-6">
      <h3 className="text-lg font-bold mb-8 text-slate-900">Funil de Etapas</h3>
          ...
          <React.Fragment key={stage.id}>
            <div className="flex flex-col items-center relative z-10">
              <div className={cn(
                ...
                stage.status === 'active' && "bg-primary/20 text-primary ring-2 ring-primary/40",
                stage.status === 'pending' && "bg-primary/10 text-primary/40"
              )}>
